...
def _ensure_import_path() -> None:
    """
    Ensure `api_server/` is in sys.path so `python api_server/.../generate_ground_truth.py` works.
    """
...
def main() -> None:
    ...
    parser.add_argument("--output", type=str, default="api_server/memory_module_v2/eval/ground_truth.jsonl")
