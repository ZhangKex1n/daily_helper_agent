...
def main() -> None:
    ...
    parser.add_argument("--labels", type=str, default="api_server/memory_module_v2/eval/ground_truth.jsonl")
    parser.add_argument("--output", type=str, default="api_server/memory_module_v2/eval/mrr_results.json")
